...
<body>
	...
	$reg=mysql_query("select nombre from etnias where nombre='$_POST[nombre]'",$con);
	if($re=mysql_fetch_array($reg))
	{
		mysql_query("delete from etnias where nombre='$_POST[nombre]'",$con);
