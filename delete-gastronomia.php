...
<html lang="es">
<head>
	<title>ELIMINAR GASTRONOMÍA</title>
...
<body>
	...
	$reg=mysql_query("select nombre from gastronomia where nombre='$_POST[nombre]'",$con);
	if($re=mysql_fetch_array($reg))
	{
		mysql_query("delete from gastronomia where nombre='$_POST[nombre]'",$con);
