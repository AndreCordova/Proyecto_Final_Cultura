...
<html lang="es">
<head>
	<title>BUSCADOR GASTRONOMÍA</title>
...
<body>
	...
	$registro=mysql_query("select * from gastronomia where nombre='$_POST[nombre]'")or die ("problema en consulta:".mysql_error());
	while ($reg=mysql_fetch_array($registro)){
		echo $reg['nombre']."<br>";
		echo $reg['ingredientes']."<br>";
